...
<body>
	...
	<section>
	<div id="showContent">
		<h4 id="show">영화 관리 &gt; 영화 추가</h4>	
		<div><form action="ScreenTheatermg.jsp" method=post> 
		  영화제목 <input type="text" name="stname" size=15> <br>
		    장르  <input type="text" name="stname" size=15> <br> 
		    개봉일  <input type="date" name="birth" size=30> <br> 
		    줄거리  <input type="text" name="stname" size=15> <br> 
		   러닝타임  <input type="text" name="stname" size=15> <br> 
