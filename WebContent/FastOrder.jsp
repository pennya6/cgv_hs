<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import = "java.sql.*,CGV_HS.*, java.util.* "%>
...
<title>CGV_HS</title>
	<style>
		...
		p{width:300px; background:rgb(241, 240, 240); padding:10px; margin-bottom:30px; margin-right:47px; float:left; text-align:left;}
...
<body>
	<header>
		...
		<div>
		<button type="button" onclick="location.href='Main.html' ">로그아웃</button></div>
		</div>
	</header>
	...
	<div id="showContent">
		...
		<%  
            ...
            //ResultSet rs = request.getmember(id,fw);
 	        
 	        //ResultSet rs = (ResultSet)DB.getticketing("c1");
 	        ResultSet rs = DB.getAllSnackRS();
 	        
 	        request.setAttribute("title", "패스트오더 주문"); 	   
