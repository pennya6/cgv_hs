...
<body>
	...
	<section>
	<div id="showContent">
		<h4 id="show">상영관 관리  &gt; 상영관 추가</h4>	
		<div><form action="InsertScreen.jsp" method=post> 
		    날짜  <input type="text" value="yyyy-mm-dd" name="date" size=15> <br>
		    시간  <input type="text" value="hh:mm:ss" name="time" size=15> <br>
		    영화제목  <input type="text"  name="title" size=15> <br>
		    극장이름  <input type="text"  name="tname" size=15> <br>
		    상영관 이름  <input type="text"  name="stname" size=15> <br>
      		
      				<br><br><input type="submit" value="추가"> 
			</form></div>
	</section>
</body>
</html>